...
namespace 'mygengo' do
  ...
  task :import => [:environment, :clear_tmp_dir] do
    sh "wget -q -O #{gengo_dir}/all.zip http://mygengo.com/string/p/wheelmap.org-website-1/export/all/cca3f4c5c05a64b00208ce53f8b0f8da39e56e27063ea77a29d874842cd8f09c"
