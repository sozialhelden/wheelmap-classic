...
describe OauthController do
  ...
  it "should redirects to the OSM registration page" do
    ...
    response.should redirect_to("#{OpenStreetMapConfig.oauth_site}/user/new?locale=de&referer=#{encoded_domain}%2Foauth%2Fauthorize%3Foauth_token%3Dab3cd9j4ks73hf7g")
  end
end