...
describe PlanetReader do
  ...
  it 'should import a new POI' do
    ...
    expect(Poi.exists?(26_735_750)).to be_truthy
    poi = Poi.find(26_735_750)
  ...
  it 'should not import poi if access is private' do
    ...
    expect(Poi.exists?(20_000_000)).to be_falsey
  end
