...
Amenities = {
  ...
  :food => %w{cafe bar pub restaurant fast_food drinking_water ice_cream},
  :leisure => %w{cinema theatre zoo nightclub gallery casino},
  :money_post => %w{post_office atm bank bureau_de_change},
  :education => %w{college  library school university museum kindergarten driving_school},
  :shopping => %w{supermarket hairdresser clothes mall furniture electronics books beverages alcohol department_store shoes hardware garden_centre optician computer bakery laundry bicycle butcher convenience doityourself dry_cleaning florist kiosk deli confectionery beauty jewelry gift toys farm_shop travel_agency outdoor organic pet fabric},
  ...
  :accommodation => %w{chalet hostel hotel motel camp_site guest_house caravan_site bed_and_breakfast},
