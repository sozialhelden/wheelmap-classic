class ChangeArtMuseumToMuseumArt < ActiveRecord::Migration
  ...
  def up
    node_type = NodeType.find_by(identifier: 'art', osm_value: 'art', icon: 'art_museum.png')
  ...
  def down
    node_type = NodeType.find_by(identifier: 'art', osm_value: 'art', icon: 'museum_art.png')
