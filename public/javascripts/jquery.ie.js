/*!
 *************************************************************************
 * IMPORTANT NOTE: THIS IS A MONKEY-PATCHED VERSION TO FIX A BUG WITH IE *
 *************************************************************************
 *
 * There is a bug in jQuery 1.5 that strikes when used in conjunction with
 * OpenLayers.js. The underlying problem is to do with VML nodes in IE 7/8
 * and has not yet been fixed (as of Feb 11, 2011). This patched version
 * needs to be used as long as the bug isn't fixed in jQuery. For more 
 * information see the corresponding ticket in the jQuery tracker:
 *
      ...
      if ( elem ) {
        ...
        if ( jQuery.nodeName( elem, "select" ) ) {
          var index = elem.selectedIndex,
            ...
            one = jQuery.elemGetType(elem) === "select-one";
        ...
        if ( rradiocheck.test( jQuery.elemGetType(elem) ) && !jQuery.support.checkOn ) {
...
if ( !jQuery.support.changeBubbles ) {
  ...
  getVal = function( elem ) {
    var type = jQuery.elemGetType(elem), val = elem.value;
  ...
  testChange = function testChange( e ) {
    ...
    if ( e.type !== "focusout" || jQuery.elemGetType(elem) !== "radio" ) {
  ...
  jQuery.event.special.change = {
    filters: {
      ...
      click: function( e ) {
        var elem = e.target, type = jQuery.elemGetType(elem);
...
var Expr = Sizzle.selectors = {
  ...
  filters: {
    enabled: function( elem ) {
      return elem.disabled === false && jQuery.elemGetType(elem) !== "hidden";
    },
    ...
    text: function( elem ) {
      return "text" === jQuery.elemGetType(elem);
    },
    radio: function( elem ) {
      return "radio" === jQuery.elemGetType(elem);
    },

    checkbox: function( elem ) {
      return "checkbox" === jQuery.elemGetType(elem);
    },

    file: function( elem ) {
      return "file" === jQuery.elemGetType(elem);
    },
    password: function( elem ) {
      return "password" === jQuery.elemGetType(elem);
    },

    submit: function( elem ) {
      return "submit" === jQuery.elemGetType(elem);
    },

    image: function( elem ) {
      return "image" === jQuery.elemGetType(elem);
    },

    reset: function( elem ) {
      return "reset" === jQuery.elemGetType(elem);
    },

    button: function( elem ) {
      return "button" === jQuery.elemGetType(elem) || elem.nodeName.toLowerCase() === "button";
    },
