...
I18n.translations["ru"] = I18n.extend((I18n.translations["ru"] || {}), {
  ...
  "community_support_form": {
    "new": {
      "form": {
        "describe": "Пожалуйста, напишите нам на английском или немецком языке.",
        "flash_after_submit": "Благодарим вас за обращение. Наша команда поддержки свяжется с вами в ближайшее время.",
        "header_text_html": "Пожалуйста, сначала ознакомьтесь с разделом  <a href=\"https://news.wheelmap.org/en/faq/\">часто задаваемых вопросов</a> для получения поддержки. Если вы не нашли там решение проблемы, пожалуйста, ответьте на следующие вопросы, чтобы мы смогли устранить ее.",
        "note": "Обращаем ваше внимание, что Wheelmap – проект с открытым исходным кодом под управлением некоммерческой организации. Наши ресурсы на разработку приложения ограничены.",
        "questions": {
          "a": "Что вы сделали?",
          "b": "Чего вы ожидали?",
          "c": "Что случилось на самом деле?"
        },
