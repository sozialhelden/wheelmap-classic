class Api::NodesController < Api::ApiController
  ...
  param :id, Integer, required: true, desc: "Node's id you want to update"
  param_group :node
  ...
  def create
    ...
    node_attributes = params.dup.delete_if { |k, _v| unwanted_keys.include? k }
